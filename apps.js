document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadSuperheroesData() {
        const xhr = new XMLHttpRequest();
        xhr.open('GET', 'superheroes.php', true);
        
        xhr.onload = function() {
            if (xhr.status === 200) {
                originalSuperheroes = parseSuperheroesFromHTML(xhr.responseText);
            }
        };
        xhr.send();
    }

    function parseSuperheroesFromHTML(html) {
